import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import"./app-sND44uRX.js";import{o as c}from"./auth-service-CzQAHVFu.js";import{e as n}from"./escape-html-BUkjI-KV.js";import{g as p,a as g,b as u,c as x}from"./admin-service-B7fwtq3Q.js";import"./firebase-config-DyDltD9C.js";class h{constructor(){this.currentUser=null,this.coursesContainer=document.querySelector(".course-cards"),this.init(),this.setupExpandTopicsDelegation()}setupExpandTopicsDelegation(){document.addEventListener("click",e=>{var s;const t=e.target.closest(".expand-more-topics-btn");if(!t)return;e.preventDefault(),e.stopPropagation();const i=t,a=i.closest(".course-description-card"),r=a==null?void 0:a.querySelector(".course-topics-extra");if(!r)return;const o=getComputedStyle(r).display==="none";r.style.display=o?"block":"none",i.textContent=o?i.dataset.lessText||"Show less":i.dataset.moreText||"+ more topics",(s=window.lucide)==null||s.createIcons()})}async init(){c(async e=>{this.currentUser=e,await this.loadCourses()})}async loadCourses(){if(this.coursesContainer)try{let e="";if(this.currentUser){const r=await p(this.currentUser.uid);r.success&&r.courses&&r.courses.length>0&&(e+=await this.renderMyCoursesSection(r.courses))}const t=await g(),i=t.success&&t.courses?t.courses:[];if(i.length===0&&!e){this.coursesContainer.innerHTML=`
