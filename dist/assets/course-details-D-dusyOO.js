import{g as n,d,a as o}from"./firebase-config-CsUtaHqz.js";/* empty css               */import"./app-CI_mKbmi.js";import{e}from"./escape-html-BUkjI-KV.js";import"./auth-service-DAVyyWu1.js";import"./global-pdf-viewer-HjeyeNNL.js";class l{constructor(){this.mainContent=document.querySelector(".page-content"),this.courseId=this.getCourseIdFromURL(),this.init()}getCourseIdFromURL(){return new URLSearchParams(window.location.search).get("id")}async init(){if(!this.courseId){this.showError("Course not found");return}await this.loadCourseDetails()}async loadCourseDetails(){if(!(!this.mainContent||!this.courseId)){this.mainContent.innerHTML=`
