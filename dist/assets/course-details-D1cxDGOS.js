import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css               */import"./app-sND44uRX.js";import{g as n,d,a as o}from"./firebase-config-DyDltD9C.js";import{e}from"./escape-html-BUkjI-KV.js";import"./auth-service-CzQAHVFu.js";class l{constructor(){this.mainContent=document.querySelector(".page-content"),this.courseId=this.getCourseIdFromURL(),this.init()}getCourseIdFromURL(){return new URLSearchParams(window.location.search).get("id")}async init(){if(!this.courseId){this.showError("Course not found");return}await this.loadCourseDetails()}async loadCourseDetails(){if(!(!this.mainContent||!this.courseId)){this.mainContent.innerHTML=`
