import"./firebase-config-BMA5n-tq.js";/* empty css               */import{o as c}from"./auth-service-BxFBpYMV.js";import{d as i,e as n,h as o}from"./admin-service-DzNgPl0W.js";const u=async(r,s)=>{try{const e=`TEST_${Date.now()}_${Math.random().toString(36).substr(2,9)}`,t=await i({userId:s,courseId:r.id,amount:r.price,paymentId:e,status:"completed"});return t.success?{success:!0}:{success:!1,error:t.error}}catch(e){return{success:!1,error:e.message||"Payment simulation failed"}}};class d{constructor(){this.course=null,this.userId=null,this.courseContent=document.getElementById("course-content"),this.init()}async init(){const e=new URLSearchParams(window.location.search).get("id");if(!e){this.courseContent.innerHTML='<div style="text-align: center; padding: var(--spacing-xl);">Course not found</div>';return}c(async t=>{t?(this.userId=t.uid,this.courseContent.innerHTML="",await this.loadCourse(e)):this.courseContent.innerHTML=`
